...
data=pd.read_csv("ICRISAT-District Level Data - ICRISAT-District Level Data.csv")
...
#i have separated cleaned dataset into 2 df
    #df_main -- Main dataset for EDA analysis & SQL Queries & Power BI (containes main columns for perform project questions)
